...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 25 Apr 2023 pada 10.06
...
(1, 'Warehouse Management', 'Warehouse Management', 'Sistem Manajemen Gudang di PHP CodeIgniter', '569 Eren Avenue', '08123456789', 'https://www.facebook.com/CIwms', 'info@gmail.com', 'https://twitter.com/', 'http://CIwms.com/', 'https://www.youtube.com/watch?v=Owbz39V_4Bo', 'd5bf7e44b3331b3d4b0c0177e3d51f31.png', 'CI PHP - Project', '2019-02-13 22:19:42', '2023-04-25 14:43:12');

-- --------------------------------------------------------

--
-- Struktur dari tabel `limitstock`
--
...
--
-- Dumping data untuk tabel `limitstock`
--
...
(16, 'Item 03', 'B TWO', 121, '2022-01-19 17:42:01', '2023-04-25 14:44:02'),
...
(20, 'controh 2', 'Contoh', 30, '2023-04-25 14:45:04', '2023-04-25 14:52:30');
...
(48, 30, '2023-04-25 07:52:30', '2023-04-25 14:52:30', '1', 20, 'admin', 4, 0),
...
(47, 10, '2023-04-25 07:44:02', '2023-04-25 14:44:02', '1', 16, 'admin', 4, 0);
...
--
-- Indeks untuk tabel `admin_level`
--
...
--
-- AUTO_INCREMENT untuk tabel `admin_level`
--
ALTER TABLE `admin_level`
...
--
-- AUTO_INCREMENT untuk tabel `limitstock`
--
ALTER TABLE `limitstock`
