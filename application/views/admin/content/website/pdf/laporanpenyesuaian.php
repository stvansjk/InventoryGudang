...
<body>
	<h1 style="text-align: center;font-size: 30px;font-weight: bold"> Daftar Barang Masuk & Keluar</h1>
		<table>
			<thead>
				<tr>
					<th>#</th>
			...
			<tbody>
				...
				<tr>
					...
					<?php if($row->status_pergerakan == 1) { ?>
						<span style="color:#5cd29d">Barang masuk</span>
						<?php } else { ?>
						<span style="color:#f96868">Barang Keluar</span>
						<?php } ?>
					</td>
					<td>
