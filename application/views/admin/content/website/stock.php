				...
				<div class="col-md-12">
					<div class="panel rounded-0">
						<div class="panel-heading">
							<h5 class="panel-title">Notifikasi Stok Edit Minimal</h5>
						</div>
						<!-- ========== Flashdata ========== -->
						...
						<div class="panel-body container-fluid">
							<form action="<?php echo site_url(); ?>website/stock/edit/<?php echo $limitstock_id; ?>" method="post" enctype="multipart/form-data" id="exampleStandardForm" autocomplete="off">
								...
								<div class="form-group form-material">
									...
									<input type="text" class="form-control input-sm" id="stock" name="stock" placeholder="Enter Stock" value="<?php echo $stock; ?>" required />
								</div>
								<div class="form-group form-material">
								...
								<div class="form-group form-material">
									<label class="control-label" for="inputText">Terakhir Diubah</label>
