			...
			<div class="col-md-12">
				<div class="panel rounded-0">
					<div class="panel-heading">
						<h5 class="panel-title">Edit Identitas Sistem</h5>
					</div>
					<!-- ========== Flashdata ========== -->
					...
					<div class="panel-body container-fluid">
						...
						id="exampleStandardForm" autocomplete="off">
							...
							<div class="form-group form-material">
								<label class="control-label" for="inputText">Deskripsi situs web</label>
							...
							<div class="form-group form-material">
								<label class="control-label" for="inputText">Situs web kata kunci</label>
