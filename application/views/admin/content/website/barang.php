...
<?php if ($action == 'view' || empty($action)) { ?>
    <div class="page">
        <div class="page-title blue">
            <h3>
                <!-- <?php echo $breadcrumb; ?> -->RPM
            </h3>
            <p>Informasi Tentang
                <!-- <?php echo $breadcrumb; ?> -->Barang
            </p>
        </div>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <b>Di buat:</b> <?php echo dateIndo($row->barang_created); ?><br>
                                                        ...
                                                        <?php if ($admin->admin_level_kode == 1) { ?>
                                                            <td class="text-center action">
                                                                ...
                                                                <a class="text-danger" href="javascript:;" data-id="<?php echo $row->id_barang; ?>" data-toggle="modal" data-target="#modal-konfirmasi" title="<?php echo $row->nama_barang; ?>">
                                            ...
                                            <div class='pagination-right'>
                                                <ul class="pagination">
                                                    <?php if ($jml_halaman > 1) {
                                                        echo pages($halaman, $jml_halaman, 'website/barang/view', $id = "");
                                                    } ?>
                                                </ul>
                                            </div>
                                        </div>
                    ...
                    <div class="panel rounded-0">
                        ...
                        <div class="panel-body container-fluid">
                            <form action="<?php echo site_url(); ?>website/barang/edit/<?php echo $id_barang; ?>" method="post" id="exampleStandardForm" autocomplete="off">
                                ...
                                <div class="form-group form-material">
                                    <label class="control-label" for="inputText">Item nama</label>
                                    <input type="text" value="<?php echo $nama_barang; ?>" class="form-control input-sm" id="nama_barang" name="nama_barang" placeholder="Item name" required />
                                </div>
                                <div class="form-group form-material">
                                    <label class="control-label" for="inputText">Brand</label>
                                    <input type="text" value="<?php echo $merek; ?>" class="form-control input-sm" id="merek" name="merek" placeholder="Brand" required />
                                </div>
                                <div class='button center'>
