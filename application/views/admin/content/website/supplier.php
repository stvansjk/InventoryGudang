            ...
            <div class="col-md-12">
                <div class="panel rounded-0">
                    <div class="panel-heading">
                        <h5 class="panel-title">Lihat Data
                            <?php echo $breadcrumb; ?>
                        </h5>
                    </div>
                    <!-- ========== Flashdata ========== -->
                        ...
                        <div class="table-full table-view">
                            ...
                            <?php if ($admin->admin_level_kode == 1) { ?>
                                            <td class="text-center action">
                                                ...
                                                <a class="text-danger" href="javascript:;" data-id="<?php echo $row->id_supplier;?>" data-toggle="modal" data-target="#modal-konfirmasi"
                ...
                <div class="panel rounded-0">
                    ...
                    <div class="panel-body container-fluid">
                        <form action="<?php echo site_url();?>website/supplier/tambah" method="post" id="exampleStandardForm" autocomplete="off">
                            ...
                            <div class="form-group form-material">
                                <label class="control-label" for="inputText">Alamnat</label>
                                <input type="text" class="form-control input-sm" id="alamat_supplier" name="alamat_supplier" placeholder="Address" required/>
                            </div>
                            <div class="form-group form-material">
                                <label class="control-label" for="inputText">Nomer Telephone</label>
